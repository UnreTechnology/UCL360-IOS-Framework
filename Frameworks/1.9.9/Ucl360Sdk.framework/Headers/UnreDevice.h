...
-(ScanError) startScan:(NSString *)unreMeasurementRegion :(NSString *)ruleId :(NSString *)drawId :(NSString*) extras :(NSString*)  standards:(NSArray<NSNumber*>*)coordinate :(NSString*) oldIds;
