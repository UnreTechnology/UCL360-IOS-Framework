...
@interface ExtraValue : NSObject

@property NSArray<NSNumber*>* value;
@property NSArray<NSArray<NSArray<NSNumber*>*>*>* rulers;
@end
...
@property NSString* drawMapId;
@property NSNumber* matchScore;
@property NSArray<NSArray<NSNumber*>*>* wallCadCoordinate;
